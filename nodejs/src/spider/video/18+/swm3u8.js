...
let url = 'https://www.siwazyw.tv/api.php/provide/vod/';
let categories = ['亚洲无码', '亚洲有码', '欧美情色', '中文字幕', '动漫卡通', '美女主播', '人妻熟女', '强奸乱伦', '美女主播', '日韩伦理', '国产自拍', '精选口爆', '同性同志', '重口味', '91大神', 'AV解说'];
...
async function init(inReq, _outResp) {
    url = inReq.server.config.swm3u8.url;
    // categories = inReq.server.config.swm3u8.categories;
    return {};
}
