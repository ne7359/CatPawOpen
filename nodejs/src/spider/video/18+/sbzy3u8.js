...
let url = 'https://apilsbzy1.com/api.php/provide/vod/at/json';
let categories = ['亚洲有码', '亚洲无码', '制服诱惑', '强奸乱伦', '巨乳美乳', '明星换脸', '中文字幕', '角色扮演', '日本女优', '成人动漫', '欧美激情', '三级片', '网爆视频', 'AV解说', '国产传媒', '主播直播', '国产精品', '国产探花', '国产乱伦', '国产丝袜', '国产SM', '国产人妻', '自拍偷拍', '同性恋'];
...
async function init(inReq, _outResp) {
    url = inReq.server.config.sbzy3u8.url;
    // categories = inReq.server.config.sbzy3u8.categories; 注：不从index.config.js读取categories内容，直接在本js内读取
    return {};
}
