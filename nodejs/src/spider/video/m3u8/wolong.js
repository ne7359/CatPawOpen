...
let url = 'https://wolongzyw.com/api.php/provide/vod/';
let categories = ["动作片","喜剧片","爱情片","科幻片","恐怖片","剧情片","战争片","国产剧","香港剧","韩国剧","欧美剧","台湾剧","日本剧","海外剧","记录片","短片","动画片","国产动漫","欧美动漫","日本动漫","港台综艺","韩国综艺","大陆综艺","泰国剧","欧美综艺","惊悚片","家庭片","古装片","历史片","悬疑片","犯罪片","短剧"];
...
async function init(inReq, _outResp) {
    // url = inReq.server.config.wolong.url;
    // categories = inReq.server.config.wolong.categories;
    return {};
}
