...
let url = 'https://www.hongniuzy2.com/api.php/provide/vod/from/hnm3u8/';
let categories = ['动作片', '爱情片', '喜剧片', '科幻片', '恐怖片', '剧情片', '战争片', '动漫电影', '短剧', '国产剧', '欧美剧', '港澳剧', '韩剧', '日剧', '台湾剧', '泰剧', '动漫', '综艺', '纪录片', '体育赛事'];
