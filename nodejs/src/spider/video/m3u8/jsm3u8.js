...
let url = 'https://jszyapi.com/api.php/provide/vod/';
let categories = ["电视剧", "电影", "欧美剧", "香港剧", "韩剧", "日剧", "马泰剧", "伦理片", "动作片", "爱情片", "喜剧片", "科幻片", "恐怖片", "剧情片", "战争片", "记录片", "动漫", "内地剧", "动画片", "中国动漫", "日本动漫", "欧美动漫", "综艺", "台湾剧", "体育赛事", "大陆综艺", "日韩综艺", "港台综艺", "欧美综艺", "灾难片", "悬疑片", "犯罪片", "奇幻片", "短剧"];
...
async function init(inReq, _outResp) {
    // url = inReq.server.config.jsm3u8.url;
    // categories = inReq.server.config.jsm3u8.categories;
    return {};
}
