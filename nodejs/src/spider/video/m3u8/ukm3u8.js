...
let url = 'https://api.ukuapi88.com/api.php/provide/vod/';
let categories = ["动作片", "喜剧片", "爱情片", "科幻片", "恐怖片", "剧情片", "战争片", "国产剧", "港澳剧", "日剧", "欧美剧", "台湾剧", "韩剧", "泰剧", "记录片", "伦理片", "奇幻片", "犯罪片", "综艺", "动漫电影", "动漫"];
...
async function init(inReq, _outResp) {
    // url = inReq.server.config.ukm3u8.url;
    // categories = inReq.server.config.ukm3u8.categories;
    return {};
}
