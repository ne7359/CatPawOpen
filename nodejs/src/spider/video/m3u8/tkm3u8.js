...
let url = 'https://api.tiankongapi.com/api.php/provide/vod/';
let categories = ["电影","电视剧","综艺","动漫","动作片","喜剧片","爱情片","科幻片","恐怖片","剧情片","战争片","国产剧","香港剧","台湾剧","韩国剧","纪录片","动画片","日本剧","泰国剧","欧美剧","国产动漫"," 日本动漫","欧美动漫","海外动漫","电影解说","大陆综艺","港台综艺","日韩综艺","欧美综艺","其他片","其他剧","体育赛事","短剧"];
...
async function init(inReq, _outResp) {
    // url = inReq.server.config.tkm3u8.url;
    // categories = inReq.server.config.tkm3u8.categories;
    return {};
}
