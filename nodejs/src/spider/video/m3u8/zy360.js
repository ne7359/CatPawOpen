...
let url = 'https://360zy.com/api.php/provide/vod/';
let categories = ["动作片", "喜剧片", "爱情片", "科幻片", "恐怖片", "剧情片", "战争片", "国产剧", "香港剧", "韩国剧", "欧美剧", "NBA", "惊悚片", "家庭篇", "古装片", "历史片", "悬疑片", "犯罪片", "灾难片", "纪录片", "短片", "动画片", "台湾剧", "日本剧", "海外剧", "泰国剧", "大陆综艺", "港台综艺", "日韩综艺", "国产动漫", "欧美动漫", "日韩动漫", "西部片", "爽文短剧", "现代都市", "年代穿越", "古装仙侠", "伦理片", "女频恋爱", "成长逆袭"];
...
async function init(inReq, _outResp) {
    // url = inReq.server.config.zy360.url;
    // categories = inReq.server.config.zy360.categories;
    return {};
}
