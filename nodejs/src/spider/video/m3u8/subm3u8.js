...
let url = 'https://subocaiji.com/api.php/provide/vod/from/subm3u8/';
let categories = ["动作片", "爱情片", "喜剧片", "科幻片", "恐怖片", "剧情片", "战争片", "动漫电影", "短剧", "大陆剧", "美剧", "港澳剧", "韩剧", "日剧", "台湾剧", "泰剧", "中国动漫", "日本动漫", "欧美动漫", "综艺", "纪录片"];
...
async function init(inReq, _outResp) {
    // url = inReq.server.config.subm3u8.url;
    // categories = inReq.server.config.subm3u8.categories;
    return {};
}
