...
let url = 'https://caiji.putaozyw.net/inc/apijson_vod.php';
let categories = ['国产情色','自拍偷拍', '日本无码', '日本有码', '人妻熟女', '中文字幕', '欧美精品', '卡通动漫', '韩国主播', '伦理三级', '传媒原创', '口爆颜射', '岛国素人', '岛国女优', '罗莉少女', '重口调教', '美颜巨乳', '岛国群交', '制服诱惑', '同性女优', 'AI合成', '乱伦背德', '探花系列', '解说AV', '高丽棒子', '国产乱伦', '网爆门'];
...
async function init(inReq, _outResp) {
    url = inReq.server.config.ptzym3u8.url;
    // categories = inReq.server.config.ptzym3u8.categories;  注：不在index.config.js读取categories。
    return {};
}
