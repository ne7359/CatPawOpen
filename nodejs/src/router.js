...
const getSpiders = async (server) => {
    const spiders = [douban, duoduo, mogg, leijing, panta, wogg, zhizhen, tgchannel, tgsou, baidu, gsm3u8, hhm3u8, hnm3u8, jinyingyun, jsm3u8, lzm3u8, snm3u8, ukm3u8, xlm3u8, zy360, didim3u8, fhm3u8, lbm3u8, milkym3u8, sbzy3u8, push, alist, baseset];
