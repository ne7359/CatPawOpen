...
let url = 'https://cj.lziapi.com/api.php/provide/vod/from/lzm3u8/';
let categories = ['动作片', '爱情片', '喜剧片', '科幻片', '恐怖片', '剧情片', '战争片', '短剧', '国产剧', '欧美剧', '香港剧', '韩国剧', '日本剧', '台湾剧', '海外剧', '泰国剧', '国产动漫', '日韩动漫', '欧美动漫', '港台动漫', '海外动漫', '大陆综艺', '港台综艺', '日韩综艺', '欧美综艺', '记录片', '足球', '篮球', '网球', '斯诺克'];
