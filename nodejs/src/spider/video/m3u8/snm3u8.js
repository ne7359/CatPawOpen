...
let url = 'https://suoniapi.com/api.php/provide/vod/from/snm3u8/';
let categories = ['动作片', '喜剧片', '爱情片', '科幻片', '恐怖片', '剧情片', '战争片', '国产剧', '欧美剧', '韩剧', '日剧', '港剧', '台剧', '海外剧', '大陆综艺', '国产动漫'];
...
async function init(inReq, _outResp) {
    //url = inReq.server.config.snm3u8.url;
    //categories = inReq.server.config.snm3u8.categories;
    return {};
}
