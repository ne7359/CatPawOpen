...
let url = 'https://json.heimuer.xyz/api.php/provide/vod/';
let categories = ["电影", "剧情片", "动作片", "冒险片", "同性片", "喜剧片", "奇幻片", "恐怖片", "电视剧", "国产剧", "港剧", "韩剧", "日剧", "悬疑片", "惊悚片", "灾难片", "爱情片", "犯罪片", "科幻片", "动画电影", "泰剧", "台剧", "欧美剧", "新马剧", "其他剧", "歌舞片", "战争片", "经典片", "网络电影", "其它片", "国产综艺", "港台综艺", "韩国综艺", "日本综艺", "欧美综艺", "新马泰综艺", "其他综艺", "古装短剧", "虐恋短剧", "逆袭短剧", "悬疑短剧", "神豪短剧", "重生短剧", "复仇短剧", "穿越短剧", "甜宠短剧", "强者短剧", "其它短剧", "欧美动漫", "日本动漫", "韩国动漫", "国产动漫", "港台动漫", "其它动漫"];
...
async function init(inReq, _outResp) {
    // url = inReq.server.config.heimuer.url;
    // categories = inReq.server.config.heimuer.categories;
    return {};
}
